...
def downLoadDirFromCos(prefix, date = getCurrentTime()):
    global file_infos
    global exists_files
...
# 进行访问量统计
def accessCount(file_infos, date = getCurrentTime()):
    downLoadJsonFile()
    # if rule == "all":
    #     dest_file_path = "./tmp/"
    # else:
    ...
    print("total visted", len(visited_files),  "files")
    print("total visited files:", visited_files)
...
def main_handler(event, context):
    ...
    uploadAccessFile(json_file_path, "/tmp/logs.json")
